Delta = function() {
  ...
  var cfg = {
    ...
    images: [
      { id: "sprites", url: "delta/images/sprites.png" },
      { id: "aliens",  url: "delta/images/aliens.png"  },
      { id: "rocks",   url: "delta/images/rocks.png"   },
      { id: "bullets", url: "delta/images/bullets.png" }
    ],

    sounds: [
      { id: "title",   name: "delta/sounds/title",   formats: ['mp3', 'ogg'], volume: 0.4,  loop: true },
      { id: "game",    name: "delta/sounds/game",    formats: ['mp3', 'ogg'], volume: 0.8,  loop: true },
      { id: "shoot",   name: "delta/sounds/shoot",   formats: ['mp3', 'ogg'], volume: 0.04, pool: 5 },
      { id: "explode", name: "delta/sounds/explode", formats: ['mp3', 'ogg'], volume: 0.10, pool: 5 }
    ],
