...
snakeHeadImage.src = "snake/resources/head.png";
snakeBodyImage = new Image();
snakeBodyImage.src = "snake/resources/body.png";
snakeTailImage = new Image();
snakeTailImage.src = "snake/resources/tail.png";

//food
foodImage = new Image();
foodImage.src = "snake/resources/food.png";
...
function animate() 
{
	...
	{
		displayText2("You so Sux.. Game Over homie");
	}
...
function displayText2(what)
{
	context.font = "30px Arial";
	context.fillText(what, 50, 80);
}
