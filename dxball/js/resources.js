...
var resources = ['dxball/img/paddle.png', 
		 'dxball/img/splash.png', 
		 'dxball/img/credit.png', 
		 'dxball/img/lselect.png', 
		 'dxball/img/ulevel.png',
		 'dxball/img/llevel.png',
		 'dxball/img/next.png',
		 'dxball/img/pause.png',
		 'dxball/img/coin.png',
		 'dxball/img/heart.png',
		 'dxball/img/multi.png',
		 'dxball/img/info.png',
		 'dxball/img/start.png' ]; 
