...
gameImgs.add([
    ["payerBaseShip", "cosmos/images/35_base.png"],
    ["corvetShip", "cosmos/images/corvet1.png"],
    ["smallTower", "cosmos/images/small_tower.png"],
    ["star3Ship", "cosmos/images/3-star-70.png"]
]);
gameImgs.loadImages();

var payerMassiveShip = new Image();
payerMassiveShip.src = "cosmos/images/35_rockets.png";
