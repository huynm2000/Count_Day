...
"title";this.Images[14].name="worldMap";this.Images[0].src="mario/images/bgsheet.png";this.Images[1].src="mario/images/endscene.gif";this.Images[2].src="mario/images/enemysheet.png";this.Images[3].src="mario/images/firemariosheet.png";this.Images[4].src="mario/images/font.gif";this.Images[5].src="mario/images/gameovergost.gif";this.Images[6].src="mario/images/itemsheet.png";this.Images[7].src="mario/images/logo.gif";this.Images[8].src="mario/images/mapsheet.png";this.Images[9].src="mario/images/mariosheet.png";this.Images[10].src="mario/images/particlesheet.png";
this.Images[11].src="mario/images/racoonmariosheet.png";this.Images[12].src="mario/images/smallmariosheet.png";this.Images[13].src="mario/images/title.gif";this.Images[14].src="mario/images/worldmap.png";Enjine.Resources.AddImages(this.Images);(new Audio).canPlayType("mario/audio/mp3")?Enjine.Resources.AddSound("1up","mario/sounds/1-up.mp3",1).AddSound("breakblock","mario/sounds/breakblock.mp3").AddSound("bump","mario/sounds/bump.mp3",4).AddSound("cannon","mario/sounds/cannon.mp3").AddSound("coin","mario/sounds/coin.mp3",5).AddSound("death","mario/sounds/death.mp3",
1).AddSound("exit","mario/sounds/exit.mp3",1).AddSound("fireball","mario/sounds/fireball.mp3",1).AddSound("jump","mario/sounds/jump.mp3").AddSound("kick","mario/sounds/kick.mp3").AddSound("pipe","mario/sounds/pipe.mp3",1).AddSound("powerdown","mario/sounds/powerdown.mp3",1).AddSound("powerup","mario/sounds/powerup.mp3",1).AddSound("sprout","mario/sounds/sprout.mp3",1).AddSound("stagestart","mario/sounds/stagestart.mp3",1).AddSound("stomp","mario/sounds/stomp.mp3",2):Enjine.Resources.AddSound("1up","mario/sounds/1-up.wav",1).AddSound("breakblock","mario/sounds/breakblock.wav").AddSound("bump",
"mario/sounds/bump.wav",2).AddSound("cannon","mario/sounds/cannon.wav").AddSound("coin","mario/sounds/coin.wav",5).AddSound("death","mario/sounds/death.wav",1).AddSound("exit","mario/sounds/exit.wav",1).AddSound("fireball","mario/sounds/fireball.wav",1).AddSound("jump","mario/sounds/jump.wav",1).AddSound("kick","mario/sounds/kick.wav",1).AddSound("message","mario/sounds/message.wav",1).AddSound("pipe","mario/sounds/pipe.wav",1).AddSound("powerdown","mario/sounds/powerdown.wav",1).AddSound("powerup","mario/sounds/powerup.wav",1).AddSound("sprout","mario/sounds/sprout.wav",1).AddSound("stagestart",
"mario/sounds/stagestart.wav",1).AddSound("stomp","mario/sounds/stomp.wav",1);Mario.Tile.LoadBehaviors()};Mario.LoadingState.prototype.Exit=function(){delete this.Images};
